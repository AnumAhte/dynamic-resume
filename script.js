...
(_a = document.getElementById('resumeForm')) === null || _a === void 0 ? void 0 : _a.addEventListener('submit', function (event) {
    ...
    if (profilePictureInput && nameElement && emailElement && phoneElement && addressElement && educationElement && experienceElement && skillsElement && usernameElement) {
        ...
        var profilePictureURL_1 = profilePictureFile ? URL.createObjectURL(profilePictureFile) : '';
        ...
        if (resumeOutputElement) {
            ...
            var existingButtons = document.getElementById("buttonsContainer");
            if (existingButtons)
            ...
            var imgElement = resumeOutputElement.querySelector(".profilePicture");
            if (imgElement && profilePictureURL_1) {
                imgElement.onload = function () { return URL.revokeObjectURL(profilePictureURL_1); };
            }
        }
        else {
